...
exports.OpenSectionParam = function(window, objectAddress) {
    ...
    if ("true" === Alloy.Globals.MenuOpen) {
        ...
        "iphone" === Ti.Platform.osname ? Alloy.Globals.mainContainer.animate(MoveLeft) : Animator.animate(Alloy.Globals.mainContainer, {
            duration: 300,
...
exports.handlerMenu = function() {
    if ("false" === Alloy.Globals.MenuOpen) {
        ...
        "iphone" === Ti.Platform.osname ? Alloy.Globals.mainContainer.animate(MoveRight) : Animator.animate(Alloy.Globals.mainContainer, {
            duration: 300,
            easing: Animator.EXP_OUT,
            left: 250
        });
